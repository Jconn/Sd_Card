...
//define needed to tell rom.h which device we are. this library relies on certain parts of the driverlib library being stored in ROM
...
#define GPIO_COMMIT				0x4C4F434B
//GPIOLOCK = PORT_BASE + 0x520
//GPIOCR = PORT_BASE + 0x524
#define GPIO_LOCK_REG ((uint32_t*)(GPIO_PORTA_BASE + 0x520))
#define GPIO_COMMIT_REG ((uint32_t*)(GPIO_PORTA_BASE + 0x524))
// "Private" Functions ------------------------------------------------------------------------------
...
static void power_on (void){
    ...
    //JC_change
  //  uint32_t lock_reg* =
    *GPIO_LOCK_REG= GPIO_UNLOCK;
    *GPIO_COMMIT_REG = 0xFF;
    ...
    MAP_GPIOPadConfigSet(SDC_GPIO_PORT_BASE, SDC_SSI_CLK | SDC_SSI_FSS, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
//	*GPIO_COMMIT_REG = 0x0;
	*GPIO_LOCK_REG = 0x0;
